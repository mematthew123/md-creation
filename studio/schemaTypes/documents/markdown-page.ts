...
export const markdownPage = defineType({
  ...
  description: 'Machine-owned. Written by the ingest run via Agent Actions; manual edits are overwritten.',
  fields: [
    defineField({
      name: 'title',
      type: 'string',
    ...
    defineField({
      ...
      type: 'text',
      rows: 30,
      description: 'Generated by the Agent Actions ingest; overwritten whenever the source page changes.',
    }),
    defineField({
      name: 'sourceHash',
      type: 'string',
